...
const NewsletterBox = () => {
  ...
  return (
    <div className="bg-primary  p-4 sm:p-8 md:p-10  shadow-lg text-center my-10">
      ...
      <form onSubmit={onSubmitHandler} className="flex flex-row sm:flex-row items-center justify-center gap-2">
        <input
          ...
          className="w-full sm:w-2/3 md:w-1/2 p-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-secondary text-gray-700"
          required
        />
        <button
          type="submit"
          className="bg-primary border-2 border-secondary text-secondary font-medium text-sm px-6 py-3 rounded-md hover:bg-secondary hover:text-primary transition-all duration-300"
        >
          Subscribe
        </button>
      </form>
